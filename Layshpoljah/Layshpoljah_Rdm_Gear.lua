function user_job_setup()
    ...
    state.IdleMode:options('Normal','PDT','MDT','lowMP')
    state.PhysicalDefenseMode:options('PDT','NukeLock')
	state.MagicalDefenseMode:options('MDT')
	state.ResistDefenseMode:options('MEVA')
	state.Weapons:options('DualWeapons','Naegling','None') --'DualWeaponsAcc','DualEvisceration','DualClubs','DualAeolian','EnspellOnly','EnspellDW'
...
function init_gear_sets()
    ...
    sets.midcast.Cure = {main="Daybreak",sub="Sors Shield",range=empty,ammo="Hasty Pinion +1",
        ...
        back=gear.dt_jse_back,waist="Luminary Sash",legs="Carmine Cuisses +1",feet="Kaykaus Boots"}
    ...
    sets.midcast.LightWeatherCure = {main="Iridal Staff",sub="Curatio Grip",range=empty,ammo="Hasty Pinion +1",
        ...
        back=gear.dt_jse_back,waist="Hachirin-no-Obi",legs="Carmine Cuisses +1",feet="Kaykaus Boots"}
	...
	sets.midcast.DurationOnlyEnfeebling = set_combine(sets.midcast['Enfeebling Magic'], {main="Bunzi's Rod",body="Atrophy Tabard +3",range="Ullr"})
	...
	sets.idle.lowMP = {main={ name="Emissary", augments={'Mag. Acc.+15','"Mag.Atk.Bns."+20','"Refresh"+1',}},
...
--		back=gear.stp_jse_back,waist="Windbuffet Belt +1",legs="Carmine Cuisses +1",feet="Carmine Greaves +1"}
	...
	sets.engaged = {ammo="Focal Orb",
		head="Taeon Chapeau", body="Ayanmo Corazza +2",  hands="Carmine Finger Gauntlets +1", legs="Carmine Cuisses +1",
		feet="Carmine Greaves +1", neck="Asperity Necklace", waist="Sailfi Belt", left_ear="Telos Earring",
	...
	sets.sub.BLM = {
		midcast = {
			Impact = {main="Bunzi's Rod",sub="Ammurapi Shield",range="Ullr",ammo=empty,
			...
			['Dark Magic'] = {main="Rubicundity",sub="Ammurapi Shield",range="Ullr",ammo=empty,
				head="Amalric Coif +1",neck="Erra Pendant",ear1="Regal Earring",ear2="Malignance Earring",
				body="Atrophy Tabard +2",hands="Leth. Gantherots +1",ring1="Metamor. Ring +1",ring2="Stikini Ring +1",
				back=gear.nuke_jse_back,waist="Luminary Sash",legs="Psycloth Lappas",feet="Amalric Nails +1"
			},

			Drain = {main="Rubicundity",sub="Ammurapi Shield",range="Ullr",ammo=empty,
			...
			Aspir = {main="Rubicundity",sub="Ammurapi Shield",range="Ullr",ammo=empty,
				head="Pixie Hairpin +1",neck="Erra Pendant",ear1="Regal Earring",ear2="Malignance Earring",
				body=gear.merlinic_nuke_body,hands=gear.chironic_enfeeble_hands,ring1="Evanescence Ring",ring2="Archon Ring",
				back=gear.nuke_jse_back,waist="Fucho-no-obi",legs="Chironic Hose",feet=gear.merlinic_aspir_feet
			},
		
			Stun = {main="Bunzi's Rod",sub="Ammurapi Shield",range="Ullr",ammo=empty,
	...
	sets.sub.NIN = {
		precast = {
			FC = {main="Colada",sub="Colada",range=empty,ammo="Impatiens",
				...
				back=gear.fc_jse_back,waist="Embla Sash",legs="Carmine Cuisses +1",feet="Amalric Nails +1"
			}
		},
	
		midcast = {
			FastRecast = {range=empty,ammo="Hasty Pinion +1",
				head="Atrophy Chapeau +2",neck="Baetyl pendant",ear1="Enchntr. Earring +1",ear2="Malignance Earring",
				body="Zendik Robe",hands="Gende. Gages +1",ring1="Kishar Ring",ring2="Prolix Ring",
				back=gear.fc_jse_back,waist="Witful Belt",legs="Psycloth Lappas",feet="Medium's Sabots"
			},
			...
			['Enhancing Magic'] = {main="Colada",sub="Colada",range=empty,ammo="Regal Gem",
				head="Telchine Cap",body="Viti. Tabard +2",hands="Atrophy Gloves +2", legs="Telchine Braconi",
				feet="Leth. Houseaux +1",neck="Duelist's torque +2", waist="Embla Sash", left_ear="Augment. Earring",
				right_ear="Mimir Earring",left_ring="Stikini Ring +1", right_ring="Stikini Ring +1", back=gear.fc_jse_back
			},

	
			['Enfeebling Magic'] = {range=empty,ammo="Regal Gem",
				head="Viti. Chapeau +2",body="Lethargy Sayon +2",hands="Regal Cuffs",legs="Chironic Hose",feet="Vitiation Boots +2",
				neck="Imbodla Necklace",waist="Rumination Sash",left_ear="Snotra Earring",right_ear="Regal Earring",
				left_ring="Kishar Ring",right_ring="Stikini Ring +1",back=gear.fc_jse_back
			},
			...
			['Elemental Magic'] = {range=empty,ammo="Ghastly Tathlum +1",
				head="Amalric Coif +1",body="Amalric Doublet +1",hands="Amalric Gages +1",legs="Amalric Slops +1",
				feet="Amalric Nails +1",neck="Baetyl Pendant",waist="Acuity Belt +1",left_ear="Friomisi Earring",
				right_ear="Regal Earring",left_ring="Shiva Ring +1",right_ring="Shiva Ring +1",back="Taubran Cape"
			}
		},

		idle = {
				lowMP = {main="Emissary",sub="Daybreak",range=empty,ammo="Homiliary",
		...
		weapons = {
			DualWeapons = {main="Naegling",sub="Sequence",range=empty
			},
			
			DualEvisceration = {main="Tauret",sub="Crepuscular Knife",range=empty
			},
			
			DualAeolian = {main="Tauret",sub="Daybreak",range=empty
			},
			
			EnspellDW = {main="Blurred Knife +1",sub="Atoyac",range="Kaja Bow",ammo="Beetle Arrow"
			},
			
			DualClubs = {main="Maxentius",sub="Thibron",range=empty
			},
			
			DualBow = {main="Naegling",sub="Tauret",range="Kaja Bow"
			}
		},

		engaged = {
			DW = {range=empty,ammo="Focal Orb",
				waist="Sailfi Belt +1",right_ear="Eabani Earring"
			}
		}
	}	
end
...
function init_gear_sets_sub_blm() 
	if sets.sub and sets.sub[player.sub_job] then
		local main_root = sets
		local sub_root = sets.sub[player.sub_job]
		local loop_tracker = S{}
		local override = function(main_root, sub_root)
			local leave = loop_tracker:contains(main_root) or loop_tracker:contains(sub_root)
			loop_tracker:add(main_root)
			loop_tracker:add(sub_root)
			if leave then return end
				for k in pairs(sub_root) do
				if slot_map[k] then -- item data
					main_root[k] = sub_root[k]
				else
					if main_root[k] == nil then -- main doesn't have that table
						main_root[k] = {}
					end
					override(main_root[k], sub_root[k]) -- recurse
				end
			end
		end
		override(main_root, sub_root)
	end
end
