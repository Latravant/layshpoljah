...
function init_gear_sets()
    ...
    body={ name="Merlinic Jubbah", augments={'Mag. Acc.+21','"Fast Cast"+6','MND+6',}},
    hands="Gende. Gages +1",
    legs={ name="Merlinic Shalwar", augments={'"Fast Cast"+5','"Dbl.Atk."+1','Mag. Acc.+12 "Mag.Atk.Bns."+12',}},
    ...
    back={ name="Lugh's Cape", augments={'INT+20','Mag. Acc+16 /Mag. Dmg.+16','Evasion+3','"Fast Cast"+5',}},}
    ...
    sets.idle = {main="Mafic Cudgel", sub="Genmei Shield", ammo="Staunch Tathlum", head="Hike Khat +1",
    body="Shamash Robe", hands={ name="Gende. Gages +1", augments={'Phys. dmg. taken -3%','"Cure" spellcasting time -5%',}},
    legs="Acad. Pants +2", feet="Mallquis Clogs +2", neck="Twilight Torque", waist="Carrier's Sash", left_ear="Etiolation Earring",
    right_ear="Colossus's Earring", left_ring="Defending Ring", right_ring="Waterfall Ring", back="Solemnity Cape",}
