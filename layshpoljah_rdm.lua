...
function init_gear_sets()
    ...
    sets.precast.FC = {    main={ name="Emissary", augments={'Mag. Acc.+15','"Mag.Atk.Bns."+20','"Refresh"+1',}},
		sub="Culminus",
		ammo="Impatiens",
    ...
    sets.midcast.Cure = {main="Tamaxchi",sub="culminus",
		...
		hands="Regal Cuffs",
		legs={ name="Chironic Hose", augments={'Weapon Skill Acc.+8','INT+6','Accuracy+8 Attack+8','Mag. Acc.+19 "Mag.Atk.Bns."+19',}},
		feet={ name="Merlinic Crackows", augments={'Pet: DEX+5','Crit.hit rate+2','Accuracy+1 Attack+1','Mag. Acc.+20 "Mag.Atk.Bns."+20',}},
		neck="Weike Torque",
    ...
    sets.midcast['Elemental Magic'] = {    main="Venabulum",
		sub="Elder's Grip +1",
    ...
    sets.idle.Weak = {main="Bolelabunga",sub="culminus",ammo="Impatiens",
    ...
    sets.idle.PDT = {main="Bolelabunga",sub="culminus",ammo="Demonry Stone",
    ...
    sets.idle.MDT = {main="Bolelabunga",sub="culminus",ammo="Demonry Stone",
        head="Gendewitha Caubeen +1",neck="Twilight Torque",ear1="Bloodgem Earring",ear2="Loquacious Earring",
    ...
    -- Normal melee group
    sets.engaged = {main="emissary", sub="culminus",
        ammo="Hasty Pinion +1",
		head="Aya. Zucchetto",
		body="Ayanmo Corazza",
		hands="Aya. Manopolas",
